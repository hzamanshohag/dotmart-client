            ...
            return (
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1 min-h-0">
                  ...
                  <h3 className="text-sm font-bold line-clamp-1 text-gray-900 group-hover:text-blue-600 transition duration-150">
                    {product.name}
                  </h3>

                  {/* Description clipping fallback layer to maintain structure height */}
                  <p className="text-xs text-gray-500 mt-1.5 line-clamp-2 leading-relaxed flex-1">
                    {product.description ||
                      "No description provided for this featured product block item details."}
                  </p>
